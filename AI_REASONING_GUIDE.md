...
Your SentryCage now has a **fully integrated AI Reasoning Agent** with:
...
docker-compose logs sentrycage | grep "AI Reasoning"
...
https://github.com/SentryCage/sentrycage
